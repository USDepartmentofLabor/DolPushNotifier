...
$.fn.toggler = function(options) {
    ...
    var $this = $(this);
    $this.wrapInner('<a style="display:inline" href="#"/>');
...
$(function() {
   ...
   //$("li.expand").toggler({initShow: "div.collapse:first"});
    // --- Other options:
   //("li.expand").toggler({method: "toggle", speed: 300});
    //$("li.expand").toggler({method: "toggle"});
    $("li.expand").toggler({speed: "fast"});
    //$("li.expand").toggler({method: "fadeToggle"});
    //$("li.expand").toggler({method: "slideFadeToggle"});    
    $("#content").expandAll({trigger: "li.expand", ref: "div.demo",  speed: 300, oneSwitch: true});
});
//--><!]]>
